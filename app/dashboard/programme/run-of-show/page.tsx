...
const statusConfig = {
  ...
  live: { label: "Live Now", color: "bg-red-500 text-white animate-pulse", icon: Play },
  upcoming: { label: "Upcoming", color: "bg-muted text-muted-foreground", icon: Clock },
}
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">H.E. Bola Tinubu • 15 minutes remaining</p>
            </div>
